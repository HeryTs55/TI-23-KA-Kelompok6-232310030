...
export default function BusinessLoanScreen({ navigation }) {
  ...
  const fieldInfo = (field) => {
    ...
    const messages = {
      ...
      loanType: `Equal total payment: Payments stay the same but the interest portion decreases while the principal portion increases.
      \n\nEqual principal payment: The principal is divided equally and interest reduces as the remaining balance decreases.`,
        ...
        <TouchableOpacity
          ...
          onPress={async () => {
            ...
            navigation.navigate('AmortizationTable', {
              amount, term, rate, startDate, loanType, repaymentType,
            });
          }}
        >
